...
import 'package:instatgram/state/comments/providers/post_comments_provider.dart';
...
import 'package:instatgram/views/components/comment/comment_tile.dart';
import 'package:instatgram/views/extensions/dismiss_keybaord.dart';
...
class PostCommentsView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useEffect((() {
      commentController.addListener(
        (() {
          hasText.value = commentController.text.isEmpty;
        }),
      );
      return (() {});
    }), [commentController]);
        ...
        actions: [
          IconButton(
            onPressed: !hasText.value
                ? (() {
                    _submiteCommentWithContriller(commentController, ref);
                  })
                : null,
  ...
  Future<void> _submiteCommentWithContriller(

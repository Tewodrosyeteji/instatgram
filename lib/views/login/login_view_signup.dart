...
import 'package:instatgram/views/components/rich_text/rich_text_widget.dart';
import 'package:instatgram/views/constants/strings.dart';
import 'package:url_launcher/url_launcher.dart';

class SigninViewSignupLink extends StatelessWidget {
  const SigninViewSignupLink({super.key});
